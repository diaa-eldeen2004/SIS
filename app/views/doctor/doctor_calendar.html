...
<head>
    ...
    <title>Calendar - Doctor Portal</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="doctor_calendar.html" class="nav-item active">
        ...
        <header class="content-header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <p style="margin: 0.5rem 0 0 0; color: var(--text-secondary);">Manage course events and student calendars.</p>
                </div>
            ...
            <section class="calendar-overview" style="margin-bottom: 2rem;">
                <div class="grid grid-4">
                    ...
                    <div class="card" style="text-align: center; padding: 1.5rem;">
                        ...
                        <div style="color: var(--text-secondary);">Upcoming Exams</div>
                    </div>
                    <div class="card" style="text-align: center; padding: 1.5rem;">
                        ...
                        <div style="color: var(--text-secondary);">Students Affected</div>
                    </div>
                </div>
            </section>
                ...
                <div class="card">
                    <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
                        <div style="flex: 1; min-width: 200px;">
                            <select class="form-input" id="courseFilter" onchange="filterCalendar()">
                ...
                <div class="card">
                    ...
                    <div class="calendar-grid" style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 1px; background-color: var(--border-color);">
                        ...
                        <div style="background-color: var(--surface-color); padding: 0.5rem; min-height: 120px; border: 1px solid var(--border-color);">
                            ...
                            <div style="background-color: var(--accent-color); color: white; padding: 0.25rem; border-radius: 4px; font-size: 0.8rem;">Office Hours</div>
                        </div>
                        <div style="background-color: var(--surface-color); padding: 0.5rem; min-height: 120px; border: 1px solid var(--border-color);">
                ...
                <div class="card">
                    ...
                    <div class="events-list">
                        ...
                        <div class="event-item" style="display: flex; align-items: center; gap: 1rem; padding: 1rem; border-bottom: 1px solid var(--border-color);">
                            ...
                            <div style="flex: 1;">
                                <h4 style="margin: 0 0 0.25rem 0; color: var(--text-primary);">Office Hours</h4>
                                <p style="margin: 0; color: var(--text-secondary); font-size: 0.9rem;">Available for student consultations</p>
                            </div>
                            <div style="text-align: right;">
                                <div style="font-size: 0.9rem; color: var(--text-secondary);">Today</div>
                        ...
                        <div class="event-item" style="display: flex; align-items: center; gap: 1rem; padding: 1rem;">
                            ...
                            <div style="flex: 1;">
                                <h4 style="margin: 0 0 0.25rem 0; color: var(--text-primary);">Midterm Exam - CS301</h4>
                                <p style="margin: 0; color: var(--text-secondary); font-size: 0.9rem;">Algorithm analysis and design exam</p>
                            </div>
                            <div style="text-align: right;">
            ...
            <section class="quick-actions" style="margin-top: 2rem;">
                <div class="card">
                    ...
                    <div class="grid grid-4">
                        ...
                        <button class="btn btn-outline" style="padding: 1.5rem; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 0.5rem;" onclick="setOfficeHours()">
                            <i class="fas fa-user-md" style="font-size: 2rem;"></i>
                            <span>Set Office Hours</span>
                        </button>
                        <button class="btn btn-outline" style="padding: 1.5rem; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 0.5rem;" onclick="manageStudentCalendar()">
                            <i class="fas fa-users" style="font-size: 2rem;"></i>
                            <span>Manage Student Calendar</span>
                        </button>
                    </div>
                </div>
            </section>
    ...
    <script>
        ...
        function setOfficeHours() {
            showNotification('Opening office hours setup...', 'info');
        }

        function manageStudentCalendar() {
            showNotification('Opening student calendar management...', 'info');
        }
