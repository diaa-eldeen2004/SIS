...
<head>
    ...
    <title>Profile - Doctor Portal</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="doctor_profile.html" class="nav-item active">
    ...
    <main class="main-content">
        ...
        <header class="content-header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h1 style="margin: 0; color: var(--text-primary);">Profile Management</h1>
                    <p style="margin: 0.5rem 0 0 0; color: var(--text-secondary);">Manage your personal information and view course statistics.</p>
                </div>
        ...
        <div class="content-body">
            ...
            <section class="profile-overview" style="margin-bottom: 2rem;">
                <div class="card">
                    <div style="display: flex; align-items: center; gap: 2rem; padding: 2rem;">
                        ...
                        <div style="flex: 1;">
                            <h2 style="margin: 0 0 0.5rem 0; color: var(--text-primary);">Dr. Michael Johnson</h2>
                            <p style="margin: 0 0 1rem 0; color: var(--text-secondary); font-size: 1.1rem;">Professor of Computer Science</p>
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 0.25rem;">Department</div>
                                    <div style="font-size: 1.1rem; font-weight: 600; color: var(--primary-color);">Computer Science</div>
                                </div>
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 0.25rem;">Experience</div>
                                    <div style="font-size: 1.1rem; font-weight: 600; color: var(--accent-color);">8 Years</div>
                                </div>
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 0.25rem;">Email</div>
                                    <div style="font-size: 1.1rem; font-weight: 600; color: var(--text-primary);">dr.johnson@university.edu</div>
                                </div>
                                <div>
            ...
            <!-- Profile Statistics -->
            <section class="profile-stats" style="margin-bottom: 2rem;">
                <div class="grid grid-4">
                    ...
                    <div class="card" style="text-align: center; padding: 1.5rem;">
                        ...
                        <div style="color: var(--text-secondary);">Assignments Created</div>
                    </div>
                    <div class="card" style="text-align: center; padding: 1.5rem;">
                        <div style="font-size: 2.5rem; color: var(--warning-color); margin-bottom: 0.5rem;">
                            <i class="fas fa-star"></i>
                        </div>
                        <div style="font-size: 1.5rem; font-weight: 700; margin-bottom: 0.25rem;">4.8</div>
                        ...
                        <div class="info-list">
                            ...
                            <div class="info-item" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; border-bottom: 1px solid var(--border-color);">
                                <div>
                                    ...
                                    <div style="font-weight: 600; color: var(--text-primary);">dr.johnson@university.edu</div>
                                </div>
                            ...
                            <div class="info-item" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; border-bottom: 1px solid var(--border-color);">
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 0.25rem;">Department</div>
                                    <div style="font-weight: 600; color: var(--text-primary);">Computer Science</div>
                                </div>
                            ...
                            <div class="info-item" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; border-bottom: 1px solid var(--border-color);">
                                <div>
                                    ...
                                    <div style="font-weight: 600; color: var(--text-primary);">Building A, Room 205</div>
                                </div>
                            ...
                            <div class="info-item" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem;">
                                <div>
                                    <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 0.25rem;">Office Hours</div>
                                    <div style="font-weight: 600; color: var(--text-primary);">Mon, Wed, Fri 2:00 PM - 4:00 PM</div>
                                </div>
                                <button class="btn btn-outline" style="padding: 0.25rem 0.5rem; font-size: 0.8rem;" onclick="editField('officeHours')">
                                    <i class="fas fa-edit"></i>
                                </button>
                            </div>
                        </div>
                ...
                <section class="course-statistics">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button class="btn btn-outline" onclick="viewDetailedStats()">
                                <i class="fas fa-chart-line"></i> Detailed
                            </button>
                        </div>
                        <div class="stats-list">
                            <div class="stat-item" style="padding: 1rem; border-bottom: 1px solid var(--border-color);">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                    <h4 style="margin: 0; color: var(--text-primary);">CS101 - Introduction to Programming</h4>
                                ...
                                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                                    ...
                                    <div style="text-align: center;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: var(--accent-color);">94%</div>
                                    ...
                                    <div style="text-align: center;">
                                        ...
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">Assignments</div>
                                    </div>
                                </div>
                            </div>
                            <div class="stat-item" style="padding: 1rem; border-bottom: 1px solid var(--border-color);">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                    <h4 style="margin: 0; color: var(--text-primary);">CS201 - Data Structures</h4>
                                    <span style="background-color: var(--success-color); color: white; padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.8rem;">Active</span>
                                </div>
                                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                                    <div style="text-align: center;">
                                    ...
                                    <div style="text-align: center;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: var(--accent-color);">89%</div>
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">Attendance</div>
                                    </div>
                                    <div style="text-align: center;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: var(--success-color);">6</div>
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">Assignments</div>
                                    </div>
                                </div>
                            </div>
                            <div class="stat-item" style="padding: 1rem;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                    <h4 style="margin: 0; color: var(--text-primary);">CS301 - Algorithms</h4>
                                    <span style="background-color: var(--success-color); color: white; padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.8rem;">Active</span>
                                </div>
                                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                                    <div style="text-align: center;">
                                    ...
                                    <div style="text-align: center;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: var(--accent-color);">96%</div>
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">Attendance</div>
                                    </div>
                                    <div style="text-align: center;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: var(--success-color);">4</div>
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">Assignments</div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Account Settings -->
            <section class="account-settings" style="margin-top: 2rem;">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                            <div>
                                ...
                                <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                    ...
                                    <label style="display: flex; align-items: center; gap: 0.5rem;">
                                        <input type="checkbox" checked>
                                        <span>Reminders for upcoming deadlines</span>
                                    </label>
                                    <label style="display: flex; align-items: center; gap: 0.5rem;">
                                        <input type="checkbox">
                            ...
                            <div>
                                <h4 style="margin-bottom: 1rem; color: var(--text-primary);">Privacy Settings</h4>
                                <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                    <label style="display: flex; align-items: center; gap: 0.5rem;">
                                        <input type="checkbox" checked>
                                    ...
                                    <label style="display: flex; align-items: center; gap: 0.5rem;">
                                        <input type="checkbox" checked>
                                        <span>Display office hours publicly</span>
                                    </label>
                                    <label style="display: flex; align-items: center; gap: 0.5rem;">
                                        <input type="checkbox">
            ...
            <div class="chat-body">
                <form class="chat-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subject" class="form-input" placeholder="Profile inquiry" required>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function viewDetailedStats() {
            showNotification('Opening detailed statistics...', 'info');
        }
